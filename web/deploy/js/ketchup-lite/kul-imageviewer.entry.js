...
const KulImageviewer = class {
    ...
    #prepDetails() {
        ...
        return (h("div", { class: "details-grid" }, h("div", { class: "details-grid__preview" }, jsx.image(this.#adapter), jsx.spinner(this.#adapter)), h("div", { class: "details-grid__actions" }, jsx.delete(this.#adapter), jsx.clearHistory(this.#adapter), jsx.undo(this.#adapter), jsx.redo(this.#adapter), jsx.save(this.#adapter)), jsx.tree(this.#adapter), h("div", { class: "details-grid__settings" }, h("slot", { name: "settings" }))));
    }
    #prepImageviewer() {
        const className = {
            'main-grid': true,
    ...
    render() {
        return (h(Host, { key: '204c482a71c4137465505974f84c2b0d4c2fcda8' }, this.kulStyle ? (h("style", { id: KUL_STYLE_ID }, this.#kulManager.theme.setKulStyle(this))) : undefined, h("div", { key: 'b10fa4f2f7da9d9b2ac28249db198288c92b9bae', id: KUL_WRAPPER_ID }, h("div", { key: '87a46237f6408f0515bb0a8a8f9ab2692e0e47df', class: "imageviewer" }, this.#prepImageviewer()))));
    }
