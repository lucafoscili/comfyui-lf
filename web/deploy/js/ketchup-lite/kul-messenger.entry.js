import { h, F as Fragment, r as registerInstance, d as createEvent, g as getElement, f as forceUpdate, H as Host } from './index-4d533537.js';
...
const KulMessenger = class {
    constructor(hostRef) {
        ...
        this.editingStatus = IMAGE_TYPE_IDS.reduce(() => {
            return null;
        }, {});
        this.history = {};
    ...
    componentWillLoad() {
        ...
        this.#adapter.get = getters(this.#adapter, this.#kulManager, this.#hasCharacters());
