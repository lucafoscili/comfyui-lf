import { h, a as getAssetPath, r as registerInstance, d as createEvent, g as getElement, f as forceUpdate, H as Host } from './index-7cf82e95.js';
import { a as KulDataCyAttributes, k as kulManagerInstance, K as KUL_WRAPPER_ID, e as KulLanguageSearch, f as KulLanguageGeneric, b as KUL_STYLE_ID } from './kul-manager-72505221.js';
...
const KulTree = class {
    ...
    render() {
        ...
        this.#rippleSurface = {};
        return (h(Host, { key: '358d4604a1995bae4fa799110a87b8fac5522932' }, this.kulStyle ? (h("style", { id: KUL_STYLE_ID }, this.#kulManager.theme.setKulStyle(this))) : undefined, h("div", { key: '822c18964cf3eb1f78da846e9f9d8eb14be73597', id: KUL_WRAPPER_ID }, h("div", { key: '2e2b3025f47b89c6c85f71ee43f2acfa3c71dc6b', class: "tree" }, this.kulFilter ? (h("kul-textfield", { kulIcon: "magnify", kulFullWidth: true, kulLabel: this.#kulManager.language.translate(KulLanguageSearch.SEARCH), kulStyling: "flat", "onKul-textfield-event": (e) => {
