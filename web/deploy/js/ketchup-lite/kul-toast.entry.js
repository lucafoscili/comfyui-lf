...
const KulToast = class {
    ...
    render() {
        return (h(Host, { key: '5a3c00f00d464f2619134d6397a6873d7f6739cd' }, this.kulStyle ? (h("style", { id: KUL_STYLE_ID }, this.#kulManager.theme.setKulStyle(this))) : undefined, h("div", { key: 'fbceb3e4a705146d2a06b6d4ad2db5711bf9ef5d', id: KUL_WRAPPER_ID }, h("div", { key: '1f6c091e230d50c0511537744aa52f8105f290fc', class: "toast" }, h("div", { key: 'b6848f1139fc43d126bdf104116582faa996f9cd', class: `toast__accent ${this.kulTimer ? 'toast__accent--temporary' : ''}` }), h("div", { key: '53cfaf59b02809b5a6d24783e67fb85597f2d365', class: "toast__message-wrapper" }, this.kulIcon ? (h("div", { class: "toast__icon" }, h("kul-image", { ...this.kulIcon }))) : undefined, this.kulMessage ? (h("div", { class: "toast__message" }, this.kulMessage)) : undefined, this.kulCloseIcon ? (h("div", { class: "toast__icon toast__icon--close", onClick: () => this.kulCloseCallback() }, h("kul-image", { ...this.kulCloseIcon }))) : undefined)))));
    }
