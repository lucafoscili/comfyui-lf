...
const kulChatCss = ".ripple-surface{cursor:pointer;height:100%;left:0;overflow:hidden;position:absolute;top:0;width:100%}.ripple{animation:ripple 0.675s ease-out;border-radius:50%;pointer-events:none;position:absolute;transform:scale(0)}@keyframes ripple{to{opacity:0;transform:scale(4)}}::-webkit-scrollbar{width:9px}::-webkit-scrollbar-thumb{background-color:var(--kul-primary-color);-webkit-transition:background-color 0.2s ease-in-out;transition:background-color 0.2s ease-in-out}::-webkit-scrollbar-track{background-color:var(--kul-background-color)}:host{--kul_chat_blur_radius:var(--kul-chat-blur-radius, 3.5px);--kul_chat_border_radius:var(--kul-chat-border-radius, 8px);--kul_chat_buttons_padding:var(--kul-chat-buttons-padding, 1em 0);--kul_chat_grid_gap:var(--kul-chat-grid-gap, 16px);--kul_chat_margin_top:var(--kul-chat-margin-top-em, 1.25em);--kul_chat_margin_bottom:var(--kul-chat-margin-bottom-em, 1em);--kul_chat_padding:var(--kul-chat-padding, 18px);--kul-chat_small_font_size:var(--kul-chat-small-font-size, 0.875em);--kul_chat_spinner_size:var(--kul-chat-spinner-size, 48px);--kul_chat_title_font_size:var(--kul-chat-title-font-size, 2em);color:var(--kul-text-color);display:block;height:100%;width:100%}#kul-component{height:100%;position:relative;width:100%}.wrapper{backdrop-filter:blur(var(--kul_chat_blur_radius));box-sizing:border-box;display:grid;height:100%;margin:auto;padding:var(--kul_chat_padding)}.wrapper--bottom-textarea{align-content:center;grid-template-areas:\"chat\" \"spinner\" \"query\";grid-template-rows:1fr auto auto}.wrapper--top-textarea{grid-template-areas:\"query\" \"chat\" \"spinner\";grid-template-rows:auto 1fr auto}.query-area{box-sizing:border-box;grid-area:query;max-width:100%;width:100%}.chat-area{align-content:start;display:grid;grid-area:chat;grid-gap:var(--kul_chat_grid_gap);grid-template-columns:1fr;overflow:auto;margin-top:var(--kul_chat_margin_top);white-space:pre-line;width:100%;word-break:normal}.spinner{grid-area:spinner;height:var(--kul_chat_spinner_size);margin:auto;width:var(--kul_chat_spinner_size)}.title{text-align:center;font-size:var(--kul_chat_title_font_size)}.empty,.text{font-size:var(--kul_chat_small_font_size);font-style:italic;opacity:0.5;text-align:center}.buttons{align-items:center;display:flex;justify-content:space-evenly;padding:var(--kul_chat_buttons_padding)}.stt{padding:0 1em}.user{display:flex;justify-content:end}.user,.llm{font-family:var(--kul-font-family);font-size:calc(var(--kul-font-size) * 1.125);max-width:100%;padding:12px}.message-container{backdrop-filter:blur(var(--kul_chat_blur_radius));background-color:rgba(var(--kul-background-color-rgb), 0.125);border:1px solid rgba(var(--kul-text-color-rgb), 0.5);border-radius:var(--kul_chat_border_radius);height:max-content;max-width:80%;position:relative;transition:background-color 225ms ease}.message-container:hover{background-color:rgba(var(--kup-primary-color-rgb), 0.325)}.message-container--assistant{justify-self:start}.message-container--user{justify-self:end}.message-container:hover .toolbar{height:50px;opacity:1;padding:8px}.toolbar{background:rgba(var(--kul-background-color-rgb), 0.775);border:0;border-bottom-left-radius:var(--kul_chat_border_radius);border-bottom-right-radius:var(--kul_chat_border_radius);border-top:1px inset rgba(var(--kul-text-color-rgb), 0.225);box-sizing:border-box;display:flex;height:0;justify-content:end;opacity:0;overflow:hidden;padding:0;transition:height 125ms ease, opacity 125ms ease, padding 125ms ease}.toolbar__button{margin:0 4px}.spinner-bar-wrapper{bottom:0;height:4px;left:0;position:absolute;width:100%}";
...
const KulChat = class {
    ...
    render() {
        return (h(Host, { key: '8c49a010139bcdb59de1699c914c751ae5104607' }, this.kulStyle && (h("style", { key: 'c8ddb798f20e877faa8a5a06df025df63a8a9560', id: KUL_STYLE_ID }, this.#kulManager.theme.setKulStyle(this))), h("div", { key: 'b322f48eb776bee44e785e116d705c70899d23ef', id: KUL_WRAPPER_ID }, h("div", { key: '79fd9ca962a5a50ec7e3ff8e07bd884c08d1c580', class: `wrapper wrapper--${this.kulLayout} wrapper--${this.state}` }, this.state === 'ready'
            ? this.#prepReady()
            : this.state === 'connecting'
                ? this.#prepConnecting()
                : this.#prepError()))));
...
const KulCode = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b4e877999c81f9f693652b19a569143bd20f8c35' }, this.kulStyle && (h("style", { key: '50d0cd75e93cad54942d72600f25251ca3c8b298', id: KUL_STYLE_ID }, this.#kulManager.theme.setKulStyle(this))), h("div", { key: '3b52e2026103de4f8bacbaff51ea8d2f2d33fbeb', id: KUL_WRAPPER_ID }, h("div", { key: '1ebd41e887239f7b990f32892fa9855a0aab5607', class: "container" }, h("div", { key: 'dd284e901058a9751a063769eac667d1d6f43dc0', class: "header" }, h("span", { key: '0c075aa471efab01ce7513a5685e01a9e9354e03', class: "title" }, this.kulLanguage), h("kul-button", { key: 'da0a68daf38423e87035eb57a385b7abb296a111', class: 'kul-slim kul-full-height', kulIcon: "content_copy", kulLabel: "Copy", kulStyling: "flat", "onKul-button-event": (e) => this.#copy(e) })), shouldPreserveSpace ? (h("pre", { class: 'body language-' + this.kulLanguage, key: this.value, ref: (el) => {
                if (el) {
                    this.#el = el;
                }
