...
const KulUpload = class {
    ...
    render() {
        ...
        return (h(Host, { key: '56641e7e77d69f57cb62ae2433511cee4b8bb9c5' }, this.kulStyle ? (h("style", { id: KUL_STYLE_ID }, this.#kulManager.theme.setKulStyle(this))) : undefined, h("div", { key: '940c544bae7468da4630ebf5bbad02926cd1db0b', id: KUL_WRAPPER_ID }, h("div", { key: '7c8adaf04a4967951c63f8ac24fa7558b6b3db20', class: `wrapper ${this.selectedFiles && this.selectedFiles.length
                ? 'wrapper--with-info'
                : ''}` }, h("div", { key: '2cd18fa5562885ea48e14c523362215d8dd656c0', class: "file-upload", onPointerDown: (e) => this.onKulEvent(e, 'pointerdown') }, h("input", { key: '03b72a713904ab3e75ebd4c79add60a742c7b43c', class: "file-upload__input", id: "upload-input", multiple: true, onChange: () => this.#handleFileChange(), ref: (el) => {
                this.#input = el;
            }, type: "file" }), h("label", { key: 'f3ab74d7b6866fdcc375c2d7f7ff78c97476f3e3', class: "file-upload__label", htmlFor: "upload-input", ref: (el) => {
                if (this.kulRipple) {
                    this.#rippleSurface = el;
                }
            } }, h("div", { key: '75cc978263a469759c591da52a2096160d6b4223', class: "file-upload__text" }, this.kulLabel))), h("div", { key: '46f9975a010aa0417465255ca9058feb978b3d6a', class: "file-info" }, hasSelectedFiles
            ? this.#prepFileInfo()
            : undefined)))));
    }
