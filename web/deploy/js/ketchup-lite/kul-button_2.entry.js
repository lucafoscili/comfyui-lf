...
const KulButton = class {
    ...
    #prepIcon(image) {
        return this.kulIcon ? (h("kul-image", { class: "button__icon kul-icon", ...image })) : undefined;
    }
    #prepLabel(className) {
    ...
    #renderButton() {
        ...
        const className = {
            ...
            'button--with-spinner': this.kulShowSpinner && !this.kulDisabled ? true : false,
        };
    ...
    #renderIconButton() {
        ...
        return [
            h("button", { "aria-label": this.rootElement.title, class: className, disabled: this.kulDisabled, onBlur: (e) => this.onKulEvent(e, 'blur'), onClick: (e) => this.onKulEvent(e, 'click'), onFocus: (e) => this.onKulEvent(e, 'focus'), onPointerDown: (e) => this.onKulEvent(e, 'pointerdown'), style: styleSpinnerContainer, value: this.value, type: this.kulType ? this.kulType : 'button' }, this.#prepRipple(), !this.kulShowSpinner || this.kulDisabled ? (h("kul-image", { ...image, kulValue: this.kulToggable && !isOn ? iconOff : this.kulIcon })) : null, this.#prepSpinner()),
