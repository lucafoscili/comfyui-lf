...
const KulCard = class {
    ...
    render() {
        ...
        return (h(Host, { style: style }, this.kulStyle ? (h("style", { id: KUL_STYLE_ID }, this.#kulManager.theme.setKulStyle(this))) : undefined, h("div", { id: KUL_WRAPPER_ID, onClick: (e) => this.onKulEvent(e, 'click'), onContextMenu: (e) => this.onKulEvent(e, 'contextmenu'), onPointerDown: (e) => this.onKulEvent(e, 'pointerdown') }, this.getLayout())));
    }
