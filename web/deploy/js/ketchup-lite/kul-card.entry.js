...
import { k as kulManagerInstance, R as RIPPLE_SURFACE_CLASS, K as KulDataCyAttributes, a as KUL_WRAPPER_ID, b as KUL_STYLE_ID } from './kul-manager-2a1960f6.js';
...
var _KulCard_kulManager, _KulCard_adapter;
const KulCard = class {
    constructor(hostRef) {
        ...
        /*-------------------------------------------------*/
        _KulCard_kulManager.set(this, kulManagerInstance());
        /*-------------------------------------------------*/
        /*           P r i v a t e   M e t h o d s         */
        /*-------------------------------------------------*/
        _KulCard_adapter.set(this, {
            actions: {
    ...
    /*-------------------------------------------------*/
    componentWillLoad() {
        __classPrivateFieldGet(this, _KulCard_kulManager, "f").language.register(this);
        __classPrivateFieldGet(this, _KulCard_kulManager, "f").theme.register(this);
    }
    componentDidLoad() {
        this.onKulEvent(new CustomEvent("ready"), "ready");
        __classPrivateFieldGet(this, _KulCard_kulManager, "f").debug.updateDebugInfo(this, "did-load");
    }
    componentWillRender() {
        if (this.kulData) {
            this.shapes = __classPrivateFieldGet(this, _KulCard_kulManager, "f").data.cell.shapes.getAll(this.kulData);
        }
        __classPrivateFieldGet(this, _KulCard_kulManager, "f").debug.updateDebugInfo(this, "will-render");
    }
    componentDidRender() {
        __classPrivateFieldGet(this, _KulCard_kulManager, "f").debug.updateDebugInfo(this, "did-render");
    }
    render() {
        ...
        return (h(Host, { style: style }, this.kulStyle ? (h("style", { id: KUL_STYLE_ID }, __classPrivateFieldGet(this, _KulCard_kulManager, "f").theme.setKulStyle(this))) : undefined, h("div", { id: KUL_WRAPPER_ID, onClick: (e) => this.onKulEvent(e, "click"), onContextMenu: (e) => this.onKulEvent(e, "contextmenu"), onPointerDown: (e) => this.onKulEvent(e, "pointerdown") }, LAYOUT_HUB[this.kulLayout.toLowerCase()](__classPrivateFieldGet(this, _KulCard_adapter, "f")))));
    }
    disconnectedCallback() {
        __classPrivateFieldGet(this, _KulCard_kulManager, "f").language.unregister(this);
        __classPrivateFieldGet(this, _KulCard_kulManager, "f").theme.unregister(this);
    }
    get rootElement() { return getElement(this); }
};
_KulCard_kulManager = new WeakMap(), _KulCard_adapter = new WeakMap();
