...
var _LFManager_instances, _LFManager_CSS_EMBEDS, _LFManager_DEBUG, _LFManager_DOM, _LFManager_MANAGERS, _LFManager_embedCss;
...
export class LFManager {
    constructor() {
        ...
        __classPrivateFieldSet(this, _LFManager_CSS_EMBEDS, new Set(['controlPanel', 'displayJson', 'imageHistogram', 'loadImages']), "f");
    ...
    initialize() {
        const widgets = {
            controlPanel: {
                add: __classPrivateFieldGet(this, _LFManager_MANAGERS, "f").widgets.add.controlPanel,
                set: __classPrivateFieldGet(this, _LFManager_MANAGERS, "f").widgets.set.controlPanel,
            },
        };
        __classPrivateFieldGet(this, _LFManager_MANAGERS, "f").nodes.register.controlPanel(widgets.controlPanel.set, widgets.controlPanel.add);
    }
    toggleDebug(value) {
...
_LFManager_CSS_EMBEDS = new WeakMap(), _LFManager_DEBUG = new WeakMap(), _LFManager_DOM = new WeakMap(), _LFManager_MANAGERS = new WeakMap(), _LFManager_instances = new WeakSet(), _LFManager_embedCss = function _LFManager_embedCss() {
