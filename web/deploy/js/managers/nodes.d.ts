...
export declare class LFNodes {
    eventHandler: {
        LF_BlurImages: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.masonry>) => void;
        LF_Boolean: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        LF_CharacterImpersonator: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        ...
        LF_ClarityEffect: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.compare>) => void;
        LF_CompareImages: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.compare>) => void;
        LF_DisplayBoolean: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        LF_DisplayFloat: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        LF_DisplayInteger: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        ...
        LF_DisplayPrimitiveAsJSON: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        LF_DisplayString: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        ...
        LF_Extractor: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        LF_Float: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        LF_ImageClassifier: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        ...
        LF_ImageListFromJSON: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.masonry>) => void;
        LF_Integer: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        LF_IsLandscape: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.tree>) => void;
        ...
        LF_LoadFileOnce: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        ...
        LF_Lora2Prompt: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        LF_LoraTag2Prompt: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        LF_MathOperation: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        LF_MultipleImageResizeForWeb: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.tree>) => void;
        ...
        LF_RegionExtractor: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        LF_ResizeImageByEdge: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.tree>) => void;
        LF_ResizeImageToDimension: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.tree>) => void;
        LF_ResizeImageToSquare: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.tree>) => void;
        ...
        LF_SamplerSelector: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        LF_SaveImageForCivitAI: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.masonry>) => void;
        LF_SaveJSON: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.tree>) => void;
        LF_SchedulerSelector: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        LF_SequentialSeedsGenerator: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        ...
        LF_Something2Number: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        LF_Something2String: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        ...
        LF_String: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        LF_SwitchFloat: (event: CustomEvent<import("../types/events").SwitchFloatPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.booleanViewer>) => void;
        ...
        LF_UpdateUsageStatistics: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.code>) => void;
        LF_UpscaleModelSelector: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
        LF_UrandomSeedGenerator: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.tree>) => void;
        LF_UsageStatistics: (event: CustomEvent<import("../types/events").CodePayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.tabBarChart>) => void;
        LF_VAESelector: (event: CustomEvent<import("../types/events").BaseDatasetPayload>, addW: BaseWidgetCallback<import("../types/widgets").CustomWidgetName.history>) => void;
    ...
    register: {
        ...
        LF_Float: (setW: import("../types/widgets").HistoryWidgetSetter) => void;
        ...
        LF_Integer: (setW: import("../types/widgets").HistoryWidgetSetter) => void;
        ...
        LF_SamplerSelector: (setW: import("../types/widgets").HistoryWidgetSetter) => void;
        ...
        LF_SchedulerSelector: (setW: import("../types/widgets").HistoryWidgetSetter) => void;
        LF_SequentialSeedsGenerator: (setW: import("../types/widgets").HistoryWidgetSetter) => void;
        ...
        LF_String: (setW: import("../types/widgets").HistoryWidgetSetter) => void;
        ...
        LF_UpscaleModelSelector: (setW: import("../types/widgets").HistoryWidgetSetter) => void;
        ...
        LF_VAESelector: (setW: import("../types/widgets").HistoryWidgetSetter) => void;
