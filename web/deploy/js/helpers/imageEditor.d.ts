import { KulButtonEventPayload, KulImageviewerEventPayload, KulSliderEventPayload, KulToggleEventPayload } from '../types/ketchup-lite/components';
...
export declare const createToggle: <ID extends string>(data: ImageEditorWidgetToggleConfig<ID>, updateCb: ImageEditorWidgetUpdateCallback) => HTMLKulToggleElement;
