...
const eventName: EventNames = 'lf-switchinteger';

const eventCb = (event: CustomEvent<SwitchIntegerPayload>) => {
...
const updateCb = (node: NodeType) => {
  ...
  const props = node.lfProps as SwitchIntegerProps;
...
export const SwitchIntegerAdapter: () => SwitchIntegerDictionaryEntry = () => {
  return {
    eventCb,
    eventName,
    updateCb,
